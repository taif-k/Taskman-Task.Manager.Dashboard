      ...
      >
        <Card.Body onClick={() => onView(task)} style={{ cursor: "pointer" }}>
          <Card.Title className="d-flex justify-content-between">
            ...
            <Dropdown align="end" onClick={(e) => e.stopPropagation()}>
              ...
              <Dropdown.Menu>
                ...
                {!task.isDemo && <Dropdown.Item onClick={handleDelete}>Delete</Dropdown.Item>}
              </Dropdown.Menu>
            </Dropdown>
          </Card.Title>
          ...
          <div className="task-meta mt-2">
            ...
            {task.label && (
              <div className="d-flex align-items-center gap-1 mt-1">
                ...
                <Badge bg={LABEL_COLORS[task.label]}>{task.label}</Badge>
              </div>
            )}
          </div>
          ...
          <div className="mt-2 d-flex align-items-center">
            {[...Array(2)].map((_, index) => (
              <Image key={index} src={sampleImg} roundedCircle width={25} height={25} />
            ))}
