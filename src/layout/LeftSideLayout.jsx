  ...
  return (
    <Col md={1} xs={12}>
      <Nav className="flex-column">
        ...
        <Nav.Link as={NavLink} to="/notification" className="mt-3">
          <img src={bellIcon} alt="notification" />
        </Nav.Link>

        <Nav.Link as={NavLink} to="/messages" className="mt-3">
          <img src={msgIcon} alt="messages" />
        </Nav.Link>

        <Nav.Link as={NavLink} to="/bar" className="mt-3">
          <img src={barIcon} alt="bar" />
        </Nav.Link>

        <Nav.Link as={NavLink} to="/below-bar" className="mt-3">
          <img src={belowBarIcon} alt="below-bar" />
        </Nav.Link>

        <Nav.Link as={NavLink} to="/clock" className="mt-3">
          <img src={clockIcon} alt="clock" />
        </Nav.Link>

        <Nav.Link as={NavLink} to="/removed-tasks" className="mt-3">
